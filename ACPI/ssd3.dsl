 ...
 *
 * Disassembly of ssd3.aml, Wed May 16 16:44:28 2018
 *
...
DefinitionBlock ("", "SSDT", 1, "HPQOEM", "84E1", 0x00000001)
{
    ...
    External (_SB_.I2C7.APIR, FieldUnitObj)
    External (_SB_.I2C7.BLCK, BuffFieldObj)
    External (_SB_.I2C7.BLEN, BuffFieldObj)
    External (_SB_.I2C7.BSTA, BuffFieldObj)
    External (_SB_.I2C7.BUF1, BuffObj)
    External (_SB_.I2C7.BUF3, BuffObj)
    External (_SB_.I2C7.BUF4, BuffObj)
    External (_SB_.I2C7.BUFF, BuffObj)
    External (_SB_.I2C7.BYAT, BuffFieldObj)
    External (_SB_.I2C7.DAT1, BuffFieldObj)
    External (_SB_.I2C7.DAT2, BuffFieldObj)
    External (_SB_.I2C7.DATA, BuffFieldObj)
    External (_SB_.I2C7.GECR, MethodObj)    // 1 Arguments
    External (_SB_.I2C7.RB01, FieldUnitObj)
    External (_SB_.I2C7.RB02, FieldUnitObj)
    External (_SB_.I2C7.RB16, FieldUnitObj)
    External (_SB_.I2C7.SECR, MethodObj)    // 2 Arguments
    External (_SB_.I2C7.STAT, BuffFieldObj)
    External (_SB_.I2C7.WEPR, MethodObj)    // 2 Arguments
    External (_SB_.I2C7.WSYS, MethodObj)    // 1 Arguments
    External (_SB_.MEGD, MethodObj)    // 2 Arguments
    ...
    Scope (\_SB)
    {
        Device (WMID)
        {
            ...
            Method (GBIF, 1, NotSerialized)
            {
                ...
                If ((\_SB.I2C7.BSTA == Zero))
                {
                    Local1 = MEGD (\_SB.I2C7.DAT1, \_SB.I2C7.DAT2)
                    Local1 -= 0x0AAA
            ...
            Method (GBCO, 0, Serialized)
            {
                ...
                {
                    Sleep (0xC8)
                    Local2 = \_SB.I2C7.GECR (0x81)
                    Local3 = \_SB.I2C7.GECR (0x78)
                    Local4 = \_SB.I2C7.GECR (0xC2)
                    Local5 = \_SB.I2C7.GECR (0x06)
                    Local6 = \_SB.I2C7.GECR (0x90)
                    Local6 &= One
                    If (((Local3 & One) == One))
                    {
                        If (((Local3 & 0x80) == 0x80))
            ...
            Method (SBCO, 4, Serialized)
            {
                ...
                If ((\_SB.ECOK == One))
                {
                    If ((Arg0 == Zero))
                    {
                        Local2 = \_SB.I2C7.GECR (0x78)
                        If (((Local2 & One) == One))
                        {
                            If (((Local2 & 0x80) == 0x80))
                            {
                                Local3 = \_SB.I2C7.GECR (0x90)
                                Local3 &= One
                                Switch (Arg1)
                                {
                                    Case (Zero)
                                ...
                                \_SB.I2C7.SECR (0xC2, Local1)
                                Sleep (0x64)
                                Local1 = \_SB.I2C7.GECR (0xC2)
            ...
            Method (GPST, 0, NotSerialized)
            {
                ...
                While ((Local2 < 0x07))
                {
                    ...
                    While ((Local3 < 0x02))
                    {
                        ...
                        Local4 += 0x80
                        \_SB.I2C7.SECR (0xC4, Local4)
                        Sleep (One)
                        Local4 = \_SB.I2C7.GECR (0xC5)
                        Local4 <<= 0x08
                        Local4 += \_SB.I2C7.GECR (0xC6)
                        If ((Local4 >= 0x05A0))
                        {
                            Local5 = 0xFF
                            Local6 = 0xFF
                        ...
                        Else
                        {
                            ...
                            {
                                \_SB.I2C7.SECR (0xC4, (\_SB.I2C7.GECR (0xC4) + One))
                                If (((\_SB.I2C7.GECR (0xC5) == Zero) && (\_SB.I2C7.GECR (0xC6) == Zero)))
                                {
            ...
            Method (SPST, 1, NotSerialized)
            {
                ...
                While ((Local2 < 0x07))
                {
                    ...
                    \_SB.I2C7.SECR (0xC4, Local4)
                    Sleep (One)
                    BCBF [((Local2 * 0x04) + Zero)] = \_SB.I2C7.GECR (
                        0xC6)
                    BCBF [((Local2 * 0x04) + One)] = \_SB.I2C7.GECR (
                        0xC5)
                    Local4++
                    \_SB.I2C7.SECR (0xC4, Local4)
                    Sleep (One)
                    BCBF [((Local2 * 0x04) + 0x02)] = \_SB.I2C7.GECR (
                        0xC6)
                    BCBF [((Local2 * 0x04) + 0x03)] = \_SB.I2C7.GECR (
                        0xC5)
                    Local2++
                }
                ...
                While ((Local1 < SizeOf (PSBF)))
                {
                    ...
                    {
                        \_SB.I2C7.SECR (0xC6, Zero)
                        \_SB.I2C7.SECR (0xC5, Zero)
                        \_SB.I2C7.SECR (0xC4, 0x1E)
                        Sleep (One)
                        Local1 = Buffer (0x80)
                            {
                                 0xFF                                             // .
                ...
                {
                    Local2 = Local1
                    \_SB.I2C7.SECR (0xC6, DerefOf (PSBF [Local1]))
                    Local1++
                    \_SB.I2C7.SECR (0xC5, DerefOf (PSBF [Local1]))
                    Local1++
                    ...
                    \_SB.I2C7.SECR (0xC4, Local2)
                    Sleep (One)
                }

                \_SB.I2C7.SECR (0xC6, One)
                \_SB.I2C7.SECR (0xC5, Zero)
                \_SB.I2C7.SECR (0xC4, 0x1E)
                Sleep (One)
                Return (Local0)
            ...
            Method (SBCT, 1, NotSerialized)
            {
                ...
                While ((Local2 < 0x07))
                {
                    ...
                    \_SB.I2C7.SECR (0xC4, Local4)
                    Sleep (One)
                    PSBF [((Local2 * 0x04) + Zero)] = \_SB.I2C7.GECR (
                        0xC6)
                    PSBF [((Local2 * 0x04) + One)] = \_SB.I2C7.GECR (
                        0xC5)
                    Local4++
                    \_SB.I2C7.SECR (0xC4, Local4)
                    Sleep (One)
                    PSBF [((Local2 * 0x04) + 0x02)] = \_SB.I2C7.GECR (
                        0xC6)
                    PSBF [((Local2 * 0x04) + 0x03)] = \_SB.I2C7.GECR (
                        0xC5)
                    Local2++
                }
                ...
                {
                    Local2 = Local1
                    \_SB.I2C7.SECR (0xC6, DerefOf (BCBF [Local1]))
                    Local1++
                    \_SB.I2C7.SECR (0xC5, DerefOf (BCBF [Local1]))
                    Local1++
                    Divide (Local2, 0x04, Local3, Local2)
                    Local2 = (Local2 * 0x04)
                    If (Local3)
            ...
            Method (GBST, 0, NotSerialized)
            {
                ...
                \_SB.I2C7.SECR (0xC4, 0x9E)
                Sleep (One)
                \_SB.I2C7.SECR (0xC4, 0x9F)
                Sleep (One)
                DerefOf (Local0 [0x02]) [Zero] = \_SB.I2C7.GECR (0xC6)
                Return (Local0)
            }
            ...
            Method (SBST, 4, NotSerialized)
            {
                    ...
                    Arg0 == 0xFF)))
                {
                    ...
                    \_SB.I2C7.SECR (0xC5, Zero)
                    \_SB.I2C7.SECR (0xC6, Arg0)
                    \_SB.I2C7.SECR (0xC4, 0x1F)
                    Sleep (One)
                }
                Else
                {
            ...
            Method (GBMF, 0, NotSerialized)
            {
                ...
                Local1 = (\_SB.I2C7.GECR (0x7C) & 0x30)
                If ((Local1 == Zero))
                {
                    DerefOf (Local0 [0x02]) [Zero] = Zero
                }
            ...
            Method (GLED, 0, NotSerialized)
            {
                ...
                Local1 = (\_SB.I2C7.GECR (0x93) & 0x02)
                If ((Local1 == 0x02))
                {
                    DerefOf (Local0 [0x02]) [Zero] = One
                }
            ...
            Method (SLED, 1, NotSerialized)
            {
                ...
                Local0 = (Arg0 & 0xFF)
                Local1 = \_SB.I2C7.GECR (0x93)
                If ((Local0 == One))
                {
                    \_SB.I2C7.WSYS (0x31)
                    \_SB.I2C7.SECR (0x93, (Local1 | 0x02))
                }
                Else
                {
                    \_SB.I2C7.WSYS (0x30)
                    \_SB.I2C7.SECR (0x93, (Local1 & 0xFD))
                }
            ...
            {
                /* 0000 */  0x35, 0x43, 0x44, 0x38, 0x31, 0x32, 0x46, 0x4A,  // 5CD812FJ
                /* 0008 */  0x51, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // QP......
                /* 0010 */  0x3C, 0x52, 0x82, 0xC7, 0x30, 0x51, 0x00, 0x00,  // <R..0Q..
                /* 0018 */  0x3C, 0x52, 0x82, 0xC7, 0x30, 0x50, 0x00, 0x00,  // <R..0P..
                ...
                /* 0078 */  0x4A, 0x41, 0x4D, 0x30, 0x31, 0x4E, 0x00, 0x00,  // JAM01N..
                /* 0080 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,  // ........
                /* 0088 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0090 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0098 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 00A0 */  0x35, 0x43, 0x44, 0x38, 0x31, 0x32, 0x46, 0x4A,  // 5CD812FJ
                /* 00A8 */  0x51, 0x50, 0x50, 0x4A, 0x32, 0x31, 0x44, 0x35,  // QPPJ21D5
            ...
            Name (EPR3, Buffer (0x0100)
            {
                ...
                /* 0098 */  0x30, 0x30, 0x31, 0x36, 0x38, 0x39, 0x39, 0x00,  // 0016899.
                /* 00A0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 00A8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 00B0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 00B8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            ...
            {
                /* 0000 */  0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01,  // ........
                /* 0008 */  0x01, 0x00, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00,  // ........
                /* 0010 */  0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00,  // ........
                /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,  // ........
                /* 0020 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  // ........
                /* 0028 */  0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0038 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0040 */  0x00, 0x01, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0048 */  0x01, 0x00, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0050 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0058 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0060 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0068 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
